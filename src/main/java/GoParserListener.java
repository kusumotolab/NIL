...
public interface GoParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link GoParser#condition}.
	 * @param ctx the parse tree
	 */
	void enterCondition(GoParser.ConditionContext ctx);
	/**
	 * Exit a parse tree produced by {@link GoParser#condition}.
	 * @param ctx the parse tree
	 */
	void exitCondition(GoParser.ConditionContext ctx);
	/**
