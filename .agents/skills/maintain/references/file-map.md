...
| `src/main/java/*Base.java`, `SwiftSupport.java`, `SwiftSupportLexer.java` | Hand-copied Java support classes from grammars-v4 `Java/` folders |
| `src/main/java/{CPP14,CSharp,Kotlin,Python,Php,UnicodeClasses,Go,JavaScript,TypeScript,Rust,Swift5}*` | Regenerated by `generateGrammarSource` |
